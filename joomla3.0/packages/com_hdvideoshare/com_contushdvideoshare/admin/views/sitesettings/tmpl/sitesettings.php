	...
	<fieldset class="adminform">
		...
		<table class="adminlist table table-striped">
			...
			<tr>
				...
				<td>Column : <input type="text" name="sidepopularvideocol"
			...
			<tr>
				...
				<td>Column : <input type="text" name="sidefeaturedvideocol"
			...
			<tr>
				...
				<td>Column : <input type="text" name="siderelatedvideocol"
			...
			<tr>
				...
				<td>Column : <input type="text" name="siderecentvideocol"
			...
			<tr>
				...
				Column : <input type="text" name="homepopularvideocol"
					...
					value="<?php echo $editsitesettings->homepopularvideowidth; ?>">
                                ...
                                <td class="radio_algin"><input type="radio" name="homepopularvideo"
			...
			<tr>
				...
				<td class="radio_algin"><input type="radio" name="homefeaturedvideo"
			...
			<tr>
				...
				<td class="radio_algin"><input type="radio" name="homerecentvideo"
			...
			<tr>
				...
				<td class="radio_algin"><input type="radio" name="seo_option"
