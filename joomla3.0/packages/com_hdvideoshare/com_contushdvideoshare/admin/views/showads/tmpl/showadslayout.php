...
<fieldset id="filter-bar" class="btn-toolbar">
	...
	<table  class="adminlist table table-striped">
		<thead>
			<tr>
				<th>#</th>
				<th class="center"><input type="checkbox" name="toggle" value=""
				...
				<th>Ad Video Path</th>
				<th class="center"><?php echo JHTML::_('grid.sort', 'Published', 'published', @$arrAdsFilter['filter_order_Dir_ads'], @$arrAdsFilter['filter_order_ads']); ?>
				</th>
				<th class="center"><?php echo JHTML::_('grid.sort', 'Ad Visits', 'clickcounts', @$arrAdsFilter['filter_order_Dir_ads'], @$arrAdsFilter['filter_order_ads']); ?>
				</th>
				<th class="center"><?php echo JHTML::_('grid.sort', 'Impression Hits', 'impressioncounts', @$arrAdsFilter['filter_order_Dir_ads'], @$arrAdsFilter['filter_order_ads']); ?>
				</th>
				<th  class="center"><?php echo JHTML::_('grid.sort', 'ID', 'Id', @$arrAdsFilter['filter_order_Dir_ads'], @$arrAdsFilter['filter_order_ads']); ?>
				</th>
			</tr>
		</thead>
		<tbody>
		...
		<tr class="<?php echo 'row' . ($i % 2); ?>">
			...
			<td class="left"><?php echo ($arrAd->typeofadd == 'mid')?'Mid Roll':'Pre/Post Roll'; ?>
			</td>		
			<td class="center"><?php echo $arrAd->postvideopath; ?>
			</td>
