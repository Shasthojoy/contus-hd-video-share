	...
	<fieldset class="adminform">
		...
		<table class="adminlist table table-striped">
			<tr>
	            ...
	            '', 'Logo Alpha');?></td>
				<td width="25%"><input type="text" name="logoalpha"
			...
			<tr>
	            ...
	            '', 'Skin Auto Hide');?></td>
				<td class="radio_algin"><input type="radio" name="skin_autohide"
			...
			<tr>
	            ...
	            '', 'Full Screen');?></td>
				<td class="radio_algin"><input type="radio" name="fullscreen"
			...
			<tr>
	            ...
	            '', 'Autoplay');?></td>
				<td class="radio_algin"><input type="radio" name="autoplay"
	            ...
	            '', 'Zoom');?></td>
				<td class="radio_algin"><input type="radio" name="zoom"
			...
			<tr>
	            ...
	            '', 'Volume');?></td>
				<td width="25%"><input type="text" name="volume"
			...
			<tr>
	            ...
	            '', 'Timer');?></td>
				<td class="radio_algin"><input type="radio" name="timer"
			...
			<tr>
	            ...
	            '', 'Share URL');?></td>
				<td class="radio_algin"><input type="radio" name="shareurl"
				...
				<td class="radio_algin"><input type="radio" name="playlist_autoplay"
			...
			<tr>
	            ...
	            '', 'HD Default');?></td>
				<td class="radio_algin"><input type="radio" name="hddefault"
	            ...
	            '', 'Playlist Open');?></td>
				<td class="radio_algin"><input type="radio" name="playlist_open"
	...
	<fieldset class="adminform">
		...
		<table class="adminlist table table-striped">
			<tr>
				...
				<td class="radio_algin" width="80%"><input type="radio" name="postrollads"
				<?php
	            ...
	            '', 'Pre-roll Ad');?></td>
				<td class="radio_algin" width="80%"><input type="radio" name="prerollads"
				<?php
...
">(If you enabled Intermediate Ad, then Pre-roll and Post-roll ads will not be played in the player.)</span>-->
	...
	<fieldset class="adminform">
		...
		<table class="adminlist table table-striped" width="80%">
			<tr>
				<td class="key"><?php echo JHTML::tooltip('Option to enable/disable Mid-roll ads', 'Mid-roll Ad', 
	            '', 'Mid-roll Ad');?></td>
				<td class="radio_algin"><input type="radio" name="midrollads"
				<?php
	            ...
	            '', 'Ad Rotate');?></td>
				<td class="radio_algin"><input type="radio" name="midadrotate"
				<?php
			...
			<tr>
				...
				<td class="radio_algin"><input type="radio" name="midrandom"
				<?php
		...
		<table class="adminlist table table-striped">
			<tr>
				...
				<td><input type="text" name="licensekey" id="licensekey" size="60"
					maxlength="200"
					value="<?php if(isset($rs_editsettings[0]->licensekey))  echo $rs_editsettings[0]->licensekey; ?>" /></td>
				<td><?php
			...
			<tr>
				...
				<td class="radio_algin"><input type="radio" name="scaletologo" id="scaletologo1"
