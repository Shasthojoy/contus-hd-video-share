	...
	<fieldset class="adminform">
		...
		<table class="adminlist table table-striped">
			...
			<tr>
				...
				<td colspan="2"><input type="radio" name="showoption" value="0" checked />Always
			...
			<tr>
				...
				<td colspan="2"><input type="checkbox" name="reopenadd" value="0"
			...
			<tr>
				<td class="key">Published</td>
                                <td colspan="2"><input type="radio" name="publish" value=1
