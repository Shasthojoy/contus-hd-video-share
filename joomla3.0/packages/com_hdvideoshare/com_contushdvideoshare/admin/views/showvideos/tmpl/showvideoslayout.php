		...
		<div class="videocont">
			...
			<?php if ($tot > 0) {
				...
				<tr>
					...
					<td valign="center" class="videoshare_closeimage" align="center"><img
						id="<?php echo $row->id; ?>"
...
<!--			<label for="search" class="filter-search-lbl">Filter:</label>-->
		...
		<div class="btn-group pull-right hidden-phone" style="float: right;">
			<select onchange="this.form.submit()" class="input-medium chzn-done" name="filter_state">
	...
	<table class="adminlist table table-striped">
		...
		<tbody id="test-list" class="ui-sortable">
		<?php
