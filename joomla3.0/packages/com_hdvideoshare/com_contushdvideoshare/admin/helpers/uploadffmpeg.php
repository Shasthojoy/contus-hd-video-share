 ...
 * @abstract      : Contus HD Video Share Uploadffmpeg Helper
...
class uploadFfmpegHelper
{
	...
	function uploadFfmpeg($arrFormData,$idval)
	{
		...
		$strTmpPath = FVPATH . DIRECTORY_SEPARATOR."images".DIRECTORY_SEPARATOR."uploads".DIRECTORY_SEPARATOR. $strTmpVidName;
		$strTargetPath = VPATH.DIRECTORY_SEPARATOR;
