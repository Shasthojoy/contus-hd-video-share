 ...
 */
class contushdvideoshareModelshowvideos extends JModelList {
	...
	function showvideosmodel() {
		...
		/**
		 *  get user groups
		 *  from joomla version above 1.6.0
		 */
		...
		/**
		 *  get user groups
		 *  from joomla version below 1.6.0
		 */
		else
		{
	...
	*/
	...
	{		
		 ...
		 */		
		if ($fileoption == 'Url'){			
			require_once(FVPATH.DIRECTORY_SEPARATOR.'helpers'.DIRECTORY_SEPARATOR.'uploadurl.php');
		...
		if ($fileoption == "Youtube"){			
			require_once(FVPATH.DIRECTORY_SEPARATOR.'helpers'.DIRECTORY_SEPARATOR.'uploadyoutube.php');
		...
		require_once(FVPATH.DIRECTORY_SEPARATOR.'helpers'.DIRECTORY_SEPARATOR.'uploadfile.php');
		...
		require_once(FVPATH.DIRECTORY_SEPARATOR.'helpers'.DIRECTORY_SEPARATOR.'uploadffmpeg.php');
