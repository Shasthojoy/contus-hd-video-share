 ...
 */
class Modelcontushdvideosharerelatedvideos extends JModelList
{
...
{
        $db = $this->getDBO();
		$relatedvideosquery="SELECT relatedcol,relatedrow,relatedwidth,seo_option,viewedconrtol,ratingscontrol
