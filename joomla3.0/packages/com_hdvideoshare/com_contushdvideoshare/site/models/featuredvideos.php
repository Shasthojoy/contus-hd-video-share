...
/**
 * Contushdvideoshare Component Featured Vidsos Model
 */
class Modelcontushdvideosharefeaturedvideos extends JModelList
{
	...
	function getfeaturevideorowcol()
	{
		...
		$featurequery="SELECT featurrow,featurcol,featurwidth,seo_option,viewedconrtol,ratingscontrol
