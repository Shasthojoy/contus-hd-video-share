 ...
 */
class Modelcontushdvideosharerecentvideos extends JModelList
{
	...
	function getrecentvideosrowcol()
	{
		...
		$recentvideosquery="select recentrow,recentcol,recentwidth,seo_option,viewedconrtol,ratingscontrol
