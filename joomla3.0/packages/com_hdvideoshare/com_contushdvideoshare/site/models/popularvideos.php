 ...
 */
class Modelcontushdvideosharepopularvideos extends JModelList
{
	...
	function getpopularvideorowcol()
	{
		...
		$popularquery="SELECT popularrow,popularcol,popularwidth,seo_option,viewedconrtol,ratingscontrol
