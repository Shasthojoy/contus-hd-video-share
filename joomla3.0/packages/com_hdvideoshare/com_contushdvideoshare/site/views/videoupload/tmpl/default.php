...
.text_tool{display: none;position: absolute;}
            ...
            ?>">
                                                    ...
                                                    <input type="hidden" name="videotype" id="videotype" value="<?php echo JRequest::getVar('type'); ?>">
                                             <input type="hidden" name="videoid" id="videoid" value="<?php echo JRequest::getVar('id'); ?>">
                                         </form>
