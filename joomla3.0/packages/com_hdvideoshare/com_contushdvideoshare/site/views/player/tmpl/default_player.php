...
?>
<script src="<?php echo JURI::base().'components/com_contushdvideoshare/js/jquery.js';?>" type="text/javascript"></script>
<script src="<?php echo JURI::base().'components/com_contushdvideoshare/js/htmltooltip.js';?>" type="text/javascript"></script>
        ...
        <?php if (!empty($this->videodetails) && (preg_match('/vimeo/', $this->videodetails->videourl)) && ($this->videodetails->videourl != '')) {
            ...
            <script type="text/javascript">
                window.onload = function(){
                    ...
                    var embedCode = '<iframe src="http://player.vimeo.com/video/<?php echo $split[3]; ?>?title=0&amp;byline=0&amp;portrait=0&amp;color=6fde9f" width="400" height="225" class="iframe_frameborder" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
...
<script type="text/javascript">
                                   ...
                                   var url="index.php?option=com_contushdvideoshare&view=commentappend&tmpl=component&id=<?php echo $this->videodetails->id; ?>&cmdid=<?php echo $this->homepagebottomsettings[0]->comment; ?>";
                                   ...
                                   function changepage(pageno)
                                   {
                                       ...
                                       var url="index.php?option=com_contushdvideoshare&view=commentappend&tmpl=component&id=<?php echo $this->videodetails->id; ?>&cmdid=2&page="+pageno;
