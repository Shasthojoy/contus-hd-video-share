...
$style = '#video-grid-container .ulvideo_thumb .video-item{margin-right:'.$this->featurevideosrowcol[0]->featurwidth . 'px; }';
...
<!--                                                <span class="video-info"><a href="<?php echo JRoute::_('index.php?option=com_contushdvideoshare&view=category&'.$featuredCategoryVal);?>"><?php echo $this->featuredvideos[$i]->category; ?></a>
                                                 </span>-->
...
<?php } ?>
                                    ...
                                    ?>
                                                            ...
                                                            <span class="floatright viewcolor"><?php echo $this->featuredvideos[$i]->times_viewed; ?> <?php echo JText::_('HDVS_VIEWS'); ?></span>
                                                       <?php } ?>
                                                        </li>
                            <?php
                                                    if ($colcount == 0)
...
//                                                    echo "<li colspan=$rem_columns></li></ul>";
//                                                }
                            ?>
                                            </div>
                                        </div>
