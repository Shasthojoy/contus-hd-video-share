...
$style = '#video-grid-container .ulvideo_thumb .video-item{margin-right:'.$this->recentvideosrowcol[0]->recentwidth . 'px; }';
...
<?php } ?>
                                    ...
                                    ?>
                                                            ...
                                                            <span class="floatright viewcolor"><?php echo $this->recentvideos[$i]->times_viewed; ?> <?php echo JText::_('HDVS_VIEWS'); ?></span>
                                                       <?php } ?>
                                                        </li>
                            <?php
                                                    if ($colcount == 0)
