...
?>" />
                    ...
                    if ($this->allowupload['allowupload'] == 1)
                            {
                   ?>
                               <input type="button" class="button add_button" value="<?php echo JText::_('HDVS_ADD_VIDEO'); ?>" onclick="window.open('<?php echo JRoute::_('index.php?option=com_contushdvideoshare&view=videoupload'); ?>','_self');">
<?php                       }
?>
                </form>
                <script type="text/javascript">
                            ...
                            <div id="imiddlecontent1" class="clearfix" >
                                    <div class="middleleftcontent clearfix">
                                        ...
                                        <a class="featured_vidimg" href="<?php echo JRoute::_('index.php?option=com_contushdvideoshare&view=player&'.$myCategoryVal.'&'.$myVideoVal,true); ?>" >
                                           <img class="yt-uix-hovercard-target" src="<?php echo $src_path; ?>"  border="0"  width="145" style=" height: 80px !important; " title="" alt="thumb_image" /></a>
