 ...
 * @abstract      : Contus HD Video Share Related Module
                ...
                <?php } ?>
                    ...
                    ?>
                           <div class="mod_video_item">
                            <a class=" info_hover featured_vidimg" rel="htmltooltip" href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&amp;view=player&amp;" . $relatedVideoVal . "&amp;" . $relatedCategoryVal); ?>" ><img class="yt-uix-hovercard-target" src="<?php echo $src_path; ?>"  border="0" title="" alt="thumb_image" /></a>
                           </div>
...
if ($flagVideo != 1) {
   $videoTitle = 'video='.JRequest::getString('video');
   $video = str_replace(':', '-', $videoTitle);
}else {
  $video = 'id='.JRequest::getInt('video');
}
}else if (isset($id) && $id != '') {
$video = 'id='.JRequest::getInt('id');
}
...
<?php }
    ...
    echo JText::_('HDVS_NO_RELATED_VIDEOS');
}
?>
