...
<div class="module_menu <?php echo $class;?> ">
     <form name="hsearch" id="hsearch" method="post" action="<?php echo JRoute::_('index.php?option=com_contushdvideoshare&view=hdvideosharesearch'); ?>"  enctype="multipart/form-data"  >
        ...
        <input type="hidden" name="searchval" id="searchval" value="<?php $searchtxtbox = JRequest::getVar('searchtxtbox','','post'); $searchval = JRequest::getVar('searchval','','post');  if (isset($searchtxtbox)) { echo$searchtxtbox; } else { echo isset($searchval)? $searchval : '';  } ?>" />
    </form>
</div>
<div class="clear"></div>
