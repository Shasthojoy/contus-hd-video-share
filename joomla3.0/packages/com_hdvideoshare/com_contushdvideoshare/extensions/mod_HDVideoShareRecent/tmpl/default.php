 ...
 * @abstract      : Contus HD Video Share Recent Module
                ...
                <?php } ?>
                    ...
                    ?>
                           <div class="mod_video_item">
                            <a class=" info_hover featured_vidimg" href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&amp;view=player&amp;" . $recentVideoVal . "&amp;" . $recentCategoryVal); ?>" ><img class="yt-uix-hovercard-target" src="<?php echo $src_path; ?>"  border="0" title="" alt="thumb_image" /></a>
                           </div>
