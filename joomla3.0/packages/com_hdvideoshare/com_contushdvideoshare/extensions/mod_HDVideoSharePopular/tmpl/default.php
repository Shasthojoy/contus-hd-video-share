                ...
                <?php } ?>
                    ...
                    ?>
                           <div class="mod_video_item">
                            <a class=" info_hover featured_vidimg" href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&amp;view=player&amp;" . $popularVideoVal . "&amp;" . $popularCategoryVal); ?>" ><img class="yt-uix-hovercard-target" src="<?php echo $src_path; ?>"  border="0" title="" alt="thumb_image" /></a>
                           </div>
...
<script type="text/javascript">
                            jQuery.noConflict();
                                jQuery(document).ready(function($){
                                    jQuery(".ulvideo_thumb,.ulvideo_thumb1").mouseover(function(){
                                         htmltooltipCallback("htmltooltip3","3",<?php echo $rtlLang;?>,'0');
                                    });
                                });
                                jQuery(document).ready(function($){
                                     htmltooltipCallback("htmltooltip3","3",<?php echo $rtlLang;?>,'1');
                                })
