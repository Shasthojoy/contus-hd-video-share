...
{
    function display() //Function to display the subcategory list
    {
    ...
    function edit() // Function to edit a particular subcategory
    {
    ...
    function save() // Function to save a subcategory
    {
    ...
    function add() // Function to add a subcategory
    {
        $view = & $this->getView('subcategory');
        if ($model = & $this->getModel('subcategory'))
        {
    ...
    function remove() // Function to delete a subcategory
    {
    ...
    function publish() // Function to publish a subcategory
    {
        $detail = JRequest::get('POST');
        $model = & $this->getModel('subcategory');
    ...
    function unpublish() // Function to unpublish a subcategory
    {
        $detail = JRequest::get('POST');
        $model = & $this->getModel('subcategory');
        $model->pubsubcategory($detail);
