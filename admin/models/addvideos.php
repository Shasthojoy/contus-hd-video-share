...
class contushdvideoshareModeladdvideos extends JModel {
    ...
    function addvideosmodel() {
        ...
        $add = array('upload_maxsize' => $upload_maxsize, 'rs_play' => $rs_play, 'per_upload' => $per_upload, 'per_upload' => $per_upload, 'allow_status' => $allow_status, 'rs_editupload' => $rs_editupload, 'rs_ads' => $rs_ads, 'rs_midads' => $rs_midads);
        return $add;
    }
