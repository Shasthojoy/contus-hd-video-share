...
<fieldset id="filter-bar">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th><input type="checkbox" name="toggle" value=""
					onClick="checkAll(<?php echo count($arrAdsList); ?>);" />
				</th>
				...
				<th>Ad Video Path</th>
				<th><?php echo JHTML::_('grid.sort', 'Published', 'published', @$arrAdsFilter['filter_order_Dir_ads'], @$arrAdsFilter['filter_order_ads']); ?>
				</th>
				<th><?php echo JHTML::_('grid.sort', 'Ad Visits', 'clickcounts', @$arrAdsFilter['filter_order_Dir_ads'], @$arrAdsFilter['filter_order_ads']); ?>
				</th>
				<th><?php echo JHTML::_('grid.sort', 'Impression Hits', 'impressioncounts', @$arrAdsFilter['filter_order_Dir_ads'], @$arrAdsFilter['filter_order_ads']); ?>
				</th>
				<th><?php echo JHTML::_('grid.sort', 'ID', 'Id', @$arrAdsFilter['filter_order_Dir_ads'], @$arrAdsFilter['filter_order_ads']); ?>
				</th>
			</tr>
		</thead>
		<tbody>
		...
		<tr class="<?php echo 'row' . ($i % 2); ?>">
			...
			<td class="center"><?php echo ($arrAd->typeofadd == 'mid')?'Mid Roll':'Pre/Post Roll'; ?>
			</td>		
