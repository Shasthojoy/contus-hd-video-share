...
<?php } ?>
 ...
 <?php if(!version_compare(JVERSION, '3.0.0', 'ge')) { ?>
	 ...
	 <?php if(!version_compare(JVERSION, '3.0.0', 'ge')) { ?>
			...
			<tr>
				<td><?php echo JHTML::tooltip('Option to enable/disable player on category page', 'Display player on category page', 
	            '', 'Display player on category page');?></td>
				<td><input type="radio" name="categoryplayer" id="categoryplayer"
				<?php if (isset($dispenable['categoryplayer']) && $dispenable['categoryplayer'] == '1') {
					echo 'checked="checked" ';
				} ?>
					value="1" />Yes</td>
				<td colspan="3"><input type="radio" name="categoryplayer"
					id="categoryplayer"
					<?php if (isset($dispenable['categoryplayer']) && $dispenable['categoryplayer'] == '0') {
						echo 'checked="checked" ';
					} ?>
					value="0" />No</td>
			</tr>
			...
			<tr>
				<td><?php echo JHTML::tooltip('Option to limit upload method for front end users', 'Select upload method(s) for users', 
	            '', 'Select upload method(s) for users');?></td>
				<td >
                                    <?php
                                    ...
                                    <option value="Upload" <?php if (isset($upload_methods['Upload'])) {
					echo 'selected';
				} ?> >Upload</option>
                                    <option value="Youtube" <?php if (isset($upload_methods['Youtube'])) {
					echo 'selected';
				} ?> >Youtube/Vimeo/Viddler/Dailymotion</option>
                                    <option value="URL" <?php if (isset($upload_methods['URL'])) {
					echo 'selected';
				} ?> >URL</option>
