...
<form action="index.php?option=com_contushdvideoshare&layout=sitesettings" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" style="position: relative;">
    <fieldset class="adminform">
        ...
        <table <?php if (version_compare(JVERSION, '3.0.0', 'ge')) { echo 'class="adminlist table table-striped"'; } else { echo 'class="admintable"'; } ?> >
            <tr>
                <td width="300px;"><?php echo JHTML::tooltip('Select the commenting system to be displayed in player page', 'Commenting System', '', 'Commenting System'); ?></td>
                <td colspan="4"><select name="comment" onchange="enablefbapi(this.value)" style="float: left;">
                        <option value="0" <?php if ($dispenable['comment'] == 0) { echo "selected=selected"; } ?>>None</option>
                        <option value="2" <?php if ($dispenable['comment'] == 2) { echo "selected=selected"; } ?>>Default</option>
                        <option value="1" <?php if ($dispenable['comment'] == 1) { echo "selected=selected"; } ?>>FaceBookComment</option>
                                <?php
                                $jomselected = "";
                                if ($this->jomcomment) {
                                ...
                                ?>
                        <option value="5" <?php if ($dispenable['comment'] == 5) { echo "selected=selected"; } ?>>Disqus Comment</option>
                    </select> 
            ...
            <tr id="facebook_api" style="display: none;" >
                ...
                <td colspan="4"><input type="text" name="facebookapi" id="facebookapi" style="display: none;" maxlength="100" value="<?php echo ($dispenable['facebookapi'] && $dispenable['comment'] == '1') ? $dispenable['facebookapi'] : ''; ?>"> </td>
            </tr>
            <tr id="disqus_api" style="display: none;" >
                ...
                <td colspan="4"><input type="text" name="disqusapi" id="disqusapi" style="display: none;" maxlength="100" value="<?php echo ($dispenable['disqusapi'] && $dispenable['comment'] == '5') ? $dispenable['disqusapi'] : ''; ?>"></td>
            </tr>
            <tr>
                <td width="300px;"><?php echo JHTML::tooltip('Enter row and column for featured videos', 'Featured Videos', '', 'Featured Videos');?></td>
                <td width="200px;">Row : <input type="text" name="featurrow" id="featurrow" maxlength="100" value="<?php echo $thumbview['featurrow']; ?>"> </td>
                <td>Column : <input type="text"  name="featurcol" id="featurcol" maxlength="100" value="<?php echo $thumbview['featurcol']; ?>"> </td>
                <td>Gutter Width : <input type="text"  name="featurwidth" id="featurwidth" maxlength="100" value="<?php echo $thumbview['featurwidth']; ?>"> </td>
                    <?php if (version_compare(JVERSION, '3.0.0', 'ge')) { ?>
                    <td>&nbsp;</td>
                    <?php } ?>
            </tr>
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for recent videos', 'Recent Videos', '', 'Recent Videos');
?></td>
...
<?php } ?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for popular videos', 'Popular Videos', '', 'Popular Videos');
?></td>
...
<?php } ?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for category view', 'Category View', '', 'Category View');
?></td>
...
<?php } ?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for Related videos', 'Related Videos', '', 'Related Videos');
?></td>
...
<?php } ?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for my videos display', 'My Videos', '', 'My Videos');
?></td>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for member videos display', 'Member Page View', '', 'Member Page View');
?></td>
...
<?php } ?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for popular videos module', 'Side Popular Videos', '', 'Side Popular Videos');
?></td>
...
<?php } ?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for featured videos module', 'Side Featured Videos', '', 'Side Featured Videos');
?></td>
...
<?php } ?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for related videos module', 'Side Related Videos', '', 'Side Related Videos');
?></td>
...
<?php if (version_compare(JVERSION, '3.0.0', 'ge')) { ?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for recent videos module', 'Side Recent Videos', '', 'Side Recent Videos');
                    ?></td>
...
<?php } ?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for popular videos in home page', 'Home Page Popular Videos', '', 'Home Page Popular Videos');
?></td>
...
?>>1</option>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for featured videos in home page', 'Home Page Featured Videos', '', 'Home Page Featured Videos');
                                 ?></td>
...
?>>3</option>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Enter row and column for recent videos in home page', 'Home Page Recent Videos', '', 'Home Page Recent Videos');
?></td>
...
?>>2</option>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Option to enable/disable video upload option to members', 'Video Upload Option to Members', '', 'Video Upload Option to Members');
                    ?></td>
...
?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Option to enable/disable admin approval from member videos', 'Admin approval for Member videos', '', 'Admin approval for Member videos');
?></td>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Option to enable/disable member Login/Register', 'Members Login/Register', '', 'Members Login/Register');
                                       ?></td>
...
?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Option to enable/disable display ratings', 'Display Ratings', '', 'Display Ratings');
                    ?></td>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Option to enable/disable views display', 'Display Viewed', '', 'Display Viewed');
                    ?></td>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Option to enable/disable player on category page', 'Display player on category page', '', 'Display player on category page');
                    ?></td>
...
?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Option to enable/disable social icons display', 'Display Social Links', '', 'Display Social Links');
?></td>
...
?>
            ...
            <tr>
                <td><?php echo JHTML::tooltip('Option to enable/disable search engine friendly url', 'Search Engine Friendly URLs', '', 'Search Engine Friendly URLs');
?></td>
