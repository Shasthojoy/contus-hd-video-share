...
<tr>
        ...
        <option value="2" <?php if($editsitesettings->comment==2) echo "selected=selected"; ?>>Default</option>
        <option value="1" <?php if($editsitesettings->comment==1) echo "selected=selected"; ?>>FaceBookComment</option>
        <?php if($this->jomcomment==1)
        {
            $jomselected="";
            ...
            echo "<option value='2'".$jomselected." >Jom Comment</option>";
        }
        else
        echo "<option value='1'".$jomselected." >Jom Comment</option>";
        ...
        if($this->jcomment==1)
        {
            ...
            echo "<option value='3'".$jcselected." >JComment</option>";
        }
        else
        echo "<option value='1'".$jcselected." >JComment</option>";
...
<tr>
        ...
        <td>
        <input type="radio" name="homepopularvideo" <?php if($editsitesettings->homepopularvideo==1){echo 'checked="checked" ';}?> value="1" />Enable
        <input type="radio" name="homepopularvideo" <?php if($editsitesettings->homepopularvideo==0){echo 'checked="checked" ';}?>value="0" />Disable
        </td>
        <td>Row :
...
<tr>
        ...
        <td>
        <input type="radio" name="homefeaturedvideo" <?php if($editsitesettings->homefeaturedvideo==1){echo 'checked="checked" ';}?> value="1" />Enable
        <input type="radio" name="homefeaturedvideo" <?php if($editsitesettings->homefeaturedvideo==0){echo 'checked="checked" ';}?>value="0" />Disable
        </td>
        <td>Row :
...
<tr>
        ...
        <td>
        <input type="radio" name="homerecentvideo" <?php if($editsitesettings->homerecentvideo==1){echo 'checked="checked" ';}?> value="1" />Enable
        <input type="radio" name="homerecentvideo" <?php if($editsitesettings->homerecentvideo==0){echo 'checked="checked" ';}?>value="0" />Disable
        </td>
        <td>Row :
  ...
  <tr>
      <td>Video Upload Option to Members:</td>
                <td>
                    <input type="radio" name="allowupload"  id="allowupload"  <?php if($editsitesettings->allowupload=='1' || $editsitesettings->allowupload==''){echo 'checked="checked" ';}?>  value="1" />Yes
                </td>
                <td colspan="3">
                    <input type="radio" name="allowupload"  id="allowupload" <?php if($editsitesettings->allowupload=='0'){echo 'checked="checked" ';}?>  value="0" />No
             ...
             <tr><td>Members Login/Register:</td>
                <td>
                    <input type="radio" name="user_login"  id="allowupload"  <?php if($editsitesettings->user_login=='1'){echo 'checked="checked" ';}?>  value="1" />Yes
                </td>
                <td colspan="3">
                    <input type="radio" name="user_login"  id="allowupload" <?php if($editsitesettings->user_login=='0'){echo 'checked="checked" ';}?>  value="0" />No
...
<tr><td>Display Ratings </td>
                <td>
                    <input type="radio" name="ratingscontrol"  id="ratingscontrol"  <?php if($editsitesettings->ratingscontrol=='1'){echo 'checked="checked" ';}?>  value="1" />Yes
                </td>
                <td colspan="3">
                    <input type="radio" name="ratingscontrol"  id="ratingscontrol" <?php if($editsitesettings->ratingscontrol=='0'){echo 'checked="checked" ';}?>  value="0" />No
...
<tr><td>Display Viewed  </td>
                <td>
                    <input type="radio" name="viewedconrtol"  id="viewedconrtol"  <?php if($editsitesettings->viewedconrtol=='1'){echo 'checked="checked" ';}?>  value="1" />Yes
                </td>
                <td colspan="3">
                    <input type="radio" name="viewedconrtol"  id="viewedconrtol" <?php if($editsitesettings->viewedconrtol=='0'){echo 'checked="checked" ';}?>  value="0" />No
           ...
           <tr><td>Search Engine Friendly URLs</td>
                <td>
                    <input type="radio" name="seo_option" <?php if($editsitesettings->seo_option==1){echo 'checked="checked" ';}?> value="1" />Enable
                </td>
                <td colspan="3">
                   <input type="radio" name="seo_option" <?php if($editsitesettings->seo_option==0){echo 'checked="checked" ';}?>value="0" />Disable
