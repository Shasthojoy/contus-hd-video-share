...
/*    h2 {background: #F9F9F9;margin: 0;padding: 10px;}
    .table-striped td{background-color: transparent !important;}
    fieldset {border: 1px solid #DFDFDF;margin-bottom: 10px;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;}*/
</style>
<?php } ?>
				...
				<div id="f1-upload-form">
					<form name="normalvideoform" method="post"
						...
						<input type="button" style="float:left;"
							name="uploadBtn" value="Upload Video" <?php if(version_compare(JVERSION, '3.0.0', 'ge')) echo 'class="modal btn"'; ?> disabled="disabled"
