...
return;
	...
	impressionurl = document.getElementById('imp r essionurl').value;
				...
				<td>
					<div id="f1-upload-form">
						<form name="normalvideoform" method="post" enctype="multipart/form-data">
							...
							<input type="button" style="float:left;" name="uploadBtn" value="Upload Video" <?php
							if (version_compare(JVERSION, '3.0.0', 'ge'))
				{
...
?> disabled="disabled" onclick="addQueue(this.form.name);" /> 
						...
						<table>
							<tr>
								...
								<td> <span id="f1-upload-cancel"> <a style="float: left;"
									href="javascript:cancelUpload('normalvideoform');" name="submitcancel">Cancel</a> </span> </td>
							</tr>
						</table>
					</div>
					<div id="nor">
			...
			<tr id="postrollurl">
				...
				<td> <input type="text" name="posturl" id="posturl" style="width: 300px" maxlength="250" value="<?php
...
?>" /> </td>
	...
	<!--Pre/Post roll ad ends here-->
		...
		?>
<form action="index.php?option=com_contushdvideoshare&layout=ads" method="post"
	  name="adminForm" id="adminForm" enctype="multipart/form-data" style="position: relative;">
	<!--IMA ad starts here-->
			...
			<tbody>
				<tr>
					...
					<td>
						...
						<input type="radio" style="float: none; margin-right: 3px; margin-left: 10px;"
							   name="imaadtype" id="videoad" value="videoad" onclick="imaads('videoad');" />Video
					</td>
				</tr>
...
?>>
			<tr id="namead">
				...
				<td><input type="text" name="adsname" id="adsname" style="width: 300px"
						   maxlength="250" value="<?php echo $rs_roll['rs_ads']->adsname; ?>" /></td>
			</tr>
			<tr id="descriptionad">				
			...
			<tr id="urltarget">
				...
				<td><input type="text" name="targeturl" id="targeturl" style="width: 300px"
						   maxlength="250" value="<?php echo $rs_roll['rs_ads']->targeturl; ?>" /></td>
			</tr>
			<tr id="urlclick">
				<td class="key">Click Hits URL</td>
				<td><input type="text" name="clickurl" id="clickurl" style="width: 300px"
						   maxlength="250" value="<?php echo $rs_roll['rs_ads']->clickurl; ?>" /></td>
			</tr>
			<tr id="impress">
				<td class="key">Impression Hits URL</td>
				<td><input type="text" name="impressionurl" id="impressionurl" style="width: 300px"
						   maxlength="250" value="<?php echo $rs_roll['rs_ads']->impressionurl; ?>" /></td>
			</tr>
			<tr>
	...
	?>" />	
	<input type="hidden" name="typeofadd" id="typeofadd" value="<?php
