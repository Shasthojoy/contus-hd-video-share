...
if (!version_compare(JVERSION, '3.0.0', 'ge'))
{
		...
		<div class="main-text">
			<div class="text" style=" text-align: justify;width: auto !important; ">
				HD Video Share is an extension for Joomla, you can create your own video sharing site in matter of minutes.
				It offers a complete video sharing solutions with advanced features such as featured videos,
				popular videos, recent videos, related videos, video search, video categories, ratings, comments,
				social sharing and more. It supports more Joomla templates by default and few paid templates
				specially made for supporting HD Video Share which are available in apptha.com for purchase.</div>
			<div class="text">
	...
	{
		?>
		<div class="well well-small"><div class="module-title nav-header">Welcome to HD Video Share</div>
			<div class="row-striped">
				<div class="row-fluid">
					<div class="span9" style=" text-align: justify;width: auto !important; ">

						<div class="row-title">
							HD Video Share is an extension for Joomla, you can create your own video sharing site in
							matter of minutes. It offers a complete video sharing solutions with advanced features such
							as featured videos, popular videos, recent videos, related videos, video search, video categories,
							ratings, comments, social sharing and more. It supports more Joomla templates by default and
							few paid templates specially made for supporting HD Video Share which are available in apptha.com
							for purchase.
						</div></div>
