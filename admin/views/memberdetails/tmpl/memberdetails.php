 ...
 * @abstract      : Contushdvideoshare Component Memberdetails View Page
...
<fieldset id="filter-bar">
		<div class="filter-search fltlft" style="float: left;">
			...
			<input type="text" title="Search in module title." value="<?php if (isset($arrMemberFilter['member_search']))
            	echo $arrMemberFilter['member_search']; ?>" id="member_search" name="member_search">
...
<!--			<select onchange="this.form.submit()" class="inputbox" name="member_upload">
	...
	<table class="adminlist">
		<thead>
			...
			?>
				...
				<th width="2%"><input type="checkbox" name="toggle" value=""
					onclick="checkAll(<?php echo count($arrMemberList['memberdetails']); ?>);" />
				</th>
				...
				<th width="8%" align="center"><?php echo JHTML::_('grid.sort', 'Allow Upload', 'allowupload', @$arrMemberFilter['filter_order_Dir'], $arrMemberFilter['filter_order']);?>
				</th>				
		...
		<tr class="<?php echo 'row' . ($i % 2); ?>">
			...
			<td align="center"><?php echo $statusImage; ?></td>
