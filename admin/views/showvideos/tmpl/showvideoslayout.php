...
<div id="videocontent" align="center">
 ...
 <table border="0" width="600" >
               <?php jimport('joomla.filter.output'); ?>
                    <?php if($tot>0){foreach($this->comment['comment'] as $row){?>
                       <?php if($row->parentid==0){
                            //echo $this->commenttitle1[0]->parentid;
                            ?>
                   <tr><td>
                    <div class="clearfix">
       ...
       // define('VPATH2', realpath(dirname(__FILE__).'/../../../components/com_contushdvideoshare/videos') );
        ...
        if ($n>=1)
        {
          ...
          <td>
           ...
           <td>
             <p class="content" style="padding:6px;">
             <?php if ( $row_showupload->streamerpath !="" ) : 
          ...
          <td>
          <?php $featured=$row_showupload->featured;
             if($featured=="1")
            {
