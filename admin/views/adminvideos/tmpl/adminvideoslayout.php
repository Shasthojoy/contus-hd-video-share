...
<script language="JavaScript" type="text/javascript">
    ...
    function submitbutton(pressbutton)
    {
        ...
        if (pressbutton == "savevideos" || pressbutton=="applyvideos")
        {
            ...
            //alert(document.getElementById('streameroption-value').value);
            //alert(document.getElementById('streamerpath-value').value);
            ...
            //            {
            //                alert( "<?php echo JText::_('You must provide a Video Duration', true); ?>" )
            //                return;
            //            }
    ...
    <table class="adminlist">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="radio" name="streameroption[]" id="streameroption1" <?php if ($editvideo['rs_editupload']->streameroption == "None" || $editvideo['rs_editupload']->streameroption == '') {
    echo 'checked="checked" ';
} ?> value="None"  checked="checked" onclick="streamer1('None');" />None
                <input type="radio" name="streameroption[]" id="streameroption2" <?php if ($editvideo['rs_editupload']->streameroption == "lighttpd") {
    echo 'checked="checked" ';
} ?>value="lighttpd"  onclick="streamer1('lighttpd');" />lighttpd
                <input type="radio" name="streameroption[]" id="streameroption3" <?php if ($editvideo['rs_editupload']->streameroption == "rtmp") {
    echo 'checked="checked" ';
        ...
        <tr><td width="200px;">File Path</td>
            <td>
                <input type="radio" name="filepath" id="filepath1" <?php if ($editvideo['rs_editupload']->filepath == "File" || $editvideo['rs_editupload']->filepath == '') {
    echo 'checked="checked" ';
} ?> value="File" onclick="fileedit('File');"  />File
                <input type="radio" name="filepath" id="filepath2"<?php if ($editvideo['rs_editupload']->filepath == "Url") {
    echo 'checked="checked" ';
} ?>value="Url" onclick="fileedit('Url');"/>Url
                <input type="radio" name="filepath" id="filepath4"<?php if ($editvideo['rs_editupload']->filepath == "Youtube") {
    echo 'checked="checked" ';
} ?>value="Youtube" onclick="fileedit('Youtube');"/>You Tube / Blip /Meta cafe /Google
                <input type="radio" name="filepath" id="filepath3"<?php if ($editvideo['rs_editupload']->filepath == "FFmpeg") {
    echo 'checked="checked" ';
...
<form action="index.php?option=com_contushdvideoshare&layout=adminvideos<?php echo (JRequest::getVar('userid', '', 'get', 'int') == 62) ? "&userid=" . JRequest::getVar('userid', '', 'get', 'int') : ""; ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
    <fieldset class="adminform">
        ...
        <table  class="adminlist" width="100%">
            ...
            <tr><td width="17%">Title</td><td width="83%"><input type="text" name="title"  id="title" style="width:300px" maxlength="250" value="<?php echo $editvideo['rs_editupload']->title; ?>" /></td></tr>
          <!-- <tr><td width="17%">SEO Title</td><td width="83%"><input type="text" name="seotitle"  id="seotitle" style="width:300px" maxlength="250" value="<?php //echo $editvideo['rs_editupload']->seotitle;  ?>" /></td></tr>-->
            <tr><td>Description</td><td><input type="text" name="description"  id="description" style="width:300px" maxlength="250" value="<?php echo $editvideo['rs_editupload']->description; ?>" /></td></tr> 
            <tr><td>Target Url</td><td><input type="text" name="targeturl"  id="targeturl" style="width:300px" maxlength="250" value="<?php echo $editvideo['rs_editupload']->targeturl; ?>" /></td></tr>
            <!-- <tr><td>Duration</td><td><input type="text" name="duration"  id="duration" style="width:50px" maxlength="8" value="<?php echo $editvideo['rs_editupload']->duration; ?>" /></td></tr> -->
...
?>
                ...
                <tr><td>Postroll ads</td>
                    <td>
                        ...
                        <input type="radio" name="postrollads"  id="postrollads"  <?php if ($editvideo['rs_editupload']->postrollads == '1') {
                            echo "inside ";
                            {
                                echo 'checked="checked" ';
                            }
                        } ?> value="1"  onclick="postroll('1');"/>Enable
                    <input type="radio" name="postrollads"  id="postrollads" <?php if ($editvideo['rs_editupload']->postrollads == '0' || $editvideo['rs_editupload']->postrollads == '') {
                            echo 'checked="checked" ';
...
?>
                ...
                <tr><td>Preroll ads</td>
                    <td>
                        <input type="radio" name="prerollads"  id="prerollads"  <?php if ($editvideo['rs_editupload']->prerollads == '1') {
                            echo 'checked="checked" ';
                        } ?>  value="1"  onclick="preroll('1');"/>Enable
                    <input type="radio" name="prerollads"  id="prerollads" <?php if ($editvideo['rs_editupload']->prerollads == '0' || $editvideo['rs_editupload']->prerollads == '') {
                            echo 'checked="checked" ';
...
?>
                ...
                <tr><td>MidRoll ads</td>
                    <td>
                        <input type="radio" name="midrollads"  id="midrollads"  <?php if ($editvideo['rs_editupload']->midrollads == '1') {
                            echo 'checked="checked" ';
                        } ?>  value="1"/>Enable
                        <input type="radio" name="midrollads"  id="midrollads" <?php if ($editvideo['rs_editupload']->midrollads == '0' || $editvideo['rs_editupload']->midrollads == '') {
                            echo 'checked="checked" ';
                        } ?> value="0"  />Disable
                    </td></tr>
                ...
                <tr><td>Download</td>
                    <td>
                        <input type="radio" name="download"  id="download"  <?php if ($editvideo['rs_editupload']->download == '1' || $editvideo['rs_editupload']->download == '') {
                            echo 'checked="checked" ';
                        } ?>  value="1" />Yes
                                <input type="radio" name="download"  id="download" <?php if ($editvideo['rs_editupload']->download == '0') {
                            echo 'checked="checked" ';
                        } ?>  value="0" />No
...
<?php $baseUrl = JURI::base() . "components/com_contushdvideoshare/"; ?>
                        ...
                        <tr><td>Published</td>
                            <td>
                                <input type="radio" name="published"  id="published"  <?php if ($editvideo['rs_editupload']->published == '1' || $editvideo['rs_editupload']->published == '') {
                            echo 'checked="checked" ';
                        } ?>  value="1" />Yes
                                <input type="radio" name="published"  id="published" <?php if ($editvideo['rs_editupload']->published == '0') {
                            echo 'checked="checked" ';
                        } ?>  value="0" />No
                ...
                <input type="hidden" name="user_id" id="user_id" value="<?php echo $editvideo['rs_editupload']->memberid; ?>" />

                <input type="hidden" name="userid" id="userid" value="<?php (JRequest::getVar('userid', '', 'post', 'int') == 62) ? JRequest::getVar('userid', '', 'post', 'int') : ""; ?>" />
