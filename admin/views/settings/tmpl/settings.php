...
if (isset($player_values['ffmpegpath']))
{
	echo $player_values['ffmpegpath'];
				...
				<tr>
					<td class="key">
						<?php echo JHTML::tooltip('Select Normal Screen Scale', 'Normal Screen Scale', '',
					...
					<td class="key">
						<?php echo JHTML::tooltip('Select Full Screen Scale', 'Full Screen Scale', '', 'Full Screen Scale'); ?></td>
...
?>
				...
				<tr>
					<td class="key">
						<?php echo JHTML::tooltip('Fullscreen button can be enable/disabled from here',
								'Full Screen', '', 'Full Screen'); ?></td>
					<td
						<?php
						if (version_compare(JVERSION, '3.0.0', 'ge'))
						{
...
?>
				...
				<tr>
					<td class="key">
						<?php echo JHTML::tooltip('Option to enable/disable default preview image when it is not available',
								'Display Default Image', '', 'Display Default Image'); ?></td>
					<td <?php
					if (version_compare(JVERSION, '3.0.0', 'ge'))
					{
						echo 'class="radio_algin"';
...
?> value="0" />Disable</td>
				...
				<tr>
					...
					<td class="key">
						<?php echo JHTML::tooltip('Option to enable/disable Download option on player', 'Enable Download', '', 'Enable Download'); ?></td>
					<td <?php
					if (version_compare(JVERSION, '3.0.0', 'ge'))
					{
						echo 'class="radio_algin"';
...
?> value="0" />Disable</td>
				...
				<tr>
					<td class="key">
						<?php echo JHTML::tooltip('Option to enable/disable Progress bar to be displayed on player',
								'Display Progress bar', '', 'Display Progress bar'); ?></td>
					<td 
						<?php
						if (version_compare(JVERSION, '3.0.0', 'ge'))
						{
...
?>
			<table class="
				...
				<tr>
					<td class="key" >
						<?php echo JHTML::tooltip('Option to enable/disable post-roll ads',
								'Post-roll Ad', '', 'Post-roll Ad'); ?> </td>
					<td  
						<?php
						if (version_compare(JVERSION, '3.0.0', 'ge'))
						{
...
?> value="1" />Enable <input type="radio" name="imaads" <?php
			...
			?> value="0" />Disable</td>
				...
				<tr>
					<td class="key"  >
						<?php echo JHTML::tooltip('Option to enable/disable Ad Skip', 'Ad Skip', '', 'Ad Skip'); ?>
					</td>
					<td
						<?php
					if (version_compare(JVERSION, '3.0.0', 'ge'))
				...
				<tr>
						...
						?>
						<td class="key">
							<?php echo JHTML::tooltip('Option to enable/disable Google Analytics',
									'Google Analytics', '', 'Google Analytics'); ?></td>
						<td 
							<?php
							if (version_compare(JVERSION, '3.0.0', 'ge'))
							{
...
?>
					<td class="key">
						<?php echo JHTML::tooltip('Option to enable/disable Google Analytics', 'Google Analytics', '', 'Google Analytics'); ?></td>
...
{
?> 
							<a style="float: left;" href="http://www.apptha.com/category/extension/Joomla/HD-Video-Share"
							   target="_blank"><img alt="" src="components/com_contushdvideoshare/images/buynow.gif" width="77"
												 height="23" style="margin: 3px 0 0 0;" /> </a> 
<?php
}
?>
					</td>
...
?>
				...
				<tr>
					<td class="key">
						<?php echo JHTML::tooltip('Select the Logo Position.Disabled in Demo Version.',
								'Logo Position', '', 'Logo Position'); ?></td>
