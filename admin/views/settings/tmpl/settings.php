        ...
        <table class="admintable">
            ...
            <tr><td class="key" width=20%>Width</td><td width=400px;><input type="text" name="width" value="<?php echo $rs_editsettings[0]->width; ?>"     /> px
                ...
                <td class="key" >Skin Auto Hide</td><td>
                    <input type="radio" name="skin_autohide" <?php if($rs_editsettings[0]->skin_autohide==1){echo 'checked="checked" ';}?> value="1" />Enable
                <input type="radio" name="skin_autohide" <?php if($rs_editsettings[0]->skin_autohide==0){echo 'checked="checked" ';}?>value="0" />Disable</td>
            ...
            <tr><td class="key">Full Screen Scale</td><td>
                ...
                <td class="key">Full Screen</td><td>
                    <input type="radio" name="fullscreen" <?php if($rs_editsettings[0]->fullscreen==1){echo 'checked="checked" ';}?>value="1" />Enable
                <input type="radio" name="fullscreen" <?php if($rs_editsettings[0]->fullscreen==0){echo 'checked="checked" ';}?>value="0" />Disable</td>

            </tr>
            <tr><td class="key">Autoplay</td><td>
                    <input type="radio" name="autoplay" <?php if($rs_editsettings[0]->autoplay==1){echo 'checked="checked" ';} ?> value="1" />Enable
                <input type="radio" name="autoplay" <?php if($rs_editsettings[0]->autoplay==0){echo 'checked="checked" ';} ?> value="0" />Disable</td>
                <td class="key">Zoom</td><td>
                    <input type="radio" name="zoom" <?php if($rs_editsettings[0]->zoom==1){echo 'checked="checked" ';}?> value="1" />Enable
                <input type="radio" name="zoom" <?php if($rs_editsettings[0]->zoom==0){echo 'checked="checked" ';}?>value="0" />Disable</td>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="timer" <?php if($rs_editsettings[0]->timer==1){echo 'checked="checked" ';}?> value="1" />Enable
                    <input type="radio" name="timer" <?php if($rs_editsettings[0]->timer==0){echo 'checked="checked" ';}?> value="0" />Disable
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="shareurl" <?php if($rs_editsettings[0]->shareurl==1){echo 'checked="checked" ';}?> value="1" />Enable
                    <input type="radio" name="shareurl" <?php if($rs_editsettings[0]->shareurl==0){echo 'checked="checked" ';}?> value="0" />Disable
                </td>
                 <td class="key">
                    Playlist Autoplay
                </td>
                <td>
                    <input type="radio" name="playlist_autoplay" <?php if($rs_editsettings[0]->playlist_autoplay==1){echo 'checked="checked" ';}?> value="1" />Enable
                    <input type="radio" name="playlist_autoplay" <?php if($rs_editsettings[0]->playlist_autoplay==0){echo 'checked="checked" ';}?> value="0" />Disable
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="hddefault" <?php if($rs_editsettings[0]->hddefault==1){echo 'checked="checked" ';}?> value="1" />Enable
                    <input type="radio" name="hddefault" <?php if($rs_editsettings[0]->hddefault==0){echo 'checked="checked" ';}?> value="0" />Disable
                </td>
                 <td class="key">
                    Playlist Open
                </td>
                <td>
                    <input type="radio" name="playlist_open" <?php if($rs_editsettings[0]->playlist_open==1){echo 'checked="checked" ';}?> value="1" />Enable
                    <input type="radio" name="playlist_open" <?php if($rs_editsettings[0]->playlist_open==0){echo 'checked="checked" ';}?> value="0" />Disable
                </td>
            </tr>
            <tr>
            ...
            <td>
            <input type="radio" name="vast" <?php if($rs_editsettings[0]->vast==1){echo 'checked="checked" ';}?> value="1" />Enable
                    <input type="radio" name="vast" <?php if($rs_editsettings[0]->vast==0){echo 'checked="checked" ';}?> value="0" />Disable
            ...
            <td>
            <input type="radio" name="Youtubeapi" <?php if($rs_editsettings[0]->Youtubeapi==1){echo 'checked="checked" ';}?> value="1" />Enable
                    <input type="radio" name="Youtubeapi" <?php if($rs_editsettings[0]->Youtubeapi==0){echo 'checked="checked" ';}?> value="0" />Disable
...
Hide youtube logo
 ...
 <td>
  <input type="radio" name="scaletologo"  id="scaletologo1"  <?php if($rs_editsettings[0]->scaletologo=='1'){echo 'checked="checked" ';}?>  checked="checked" value="1" />True
  <input type="radio" name="scaletologo"  id="scaletologo2" <?php if($rs_editsettings[0]->scaletologo=='0'){echo 'checked="checked" ';}?> value="0"/>False
   ...
   <fieldset class="adminform">
    ...
    <fieldset class="adminform">
        ...
        <td><?php echo $rs_editsettings[0]->licensekey; ?></td>
         ...
         {
         ?>
           <a href="http://www.hdvideoshare.net/shop/index.php?main_page=products_all" target="_blank"><img  src="components/com_contushdvideoshare/images/buynow.gif" width="77" height="23" /></a>
           <?php
         }
           ?>
          </td>
