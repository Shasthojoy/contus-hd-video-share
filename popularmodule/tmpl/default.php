...
<?php } ?>
                                ...
                                <div class="show-title-container" id="title">
                                    <a href="index.php?option=com_contushdvideoshare&view=player&<?php echo $popularCategoryVal; ?>&<?php echo $popularVideoValVal; ?>" class="show-title-gray info_hover"><?php if (strlen($result[$i]->title) > 18) {
                                ...
                                <div class="video-info" id="catagory-view">
                                    ...
                                    <span><?PHP ECHO _HDVS_CATEGORY; ?>: </span><a href="index.php?option=com_contushdvideoshare&view=category&<?php echo $popularCategoryVal; ?>"><?php echo $result[$i]->category; ?></a>
                                </div>
...
<?php $t = count($result);
                                if ($t > 1) { ?><div class="clear"></div>
                                    <div align="right" class="morevideos"><a href="index.php?option=com_contushdvideoshare&view=popularvideos"><?php echo _HDVS_MORE_VIDEOS; ?></a></div><?php } ?>
<div class="clear"></div>
