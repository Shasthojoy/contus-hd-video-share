...
<br/>
                ...
                <!-- Code end here for related videos in home page display -->
...
<a class="tooltip" href="index.php?option=com_contushdvideoshare&view=player&<?php echo $relatedCategoryVal; ?>&<?php echo $relatedVideoVal; ?>" class="info_hover"><img class="yt-uix-hovercard-target" src="<?php echo $src_path; ?>"  border="0"  width="145" height="80" title=""  />
  ...
  <div class="show-title-container" id="title">
    <a href="index.php?option=com_contushdvideoshare&view=player&<?php echo $relatedCategoryVal;?>&<?php echo $relatedVideoVal;?>" class="show-title-gray info_hover"><?php if(strlen($result[$i]->title)>18) { echo (substr($result[$i]->title,0,18))."..."; } else { echo $result[$i]->title; }?></a>
  </div>

<div class="video-info" id="catagory-view">

    <span><?PHP ECHO _HDVS_CATEGORY; ?>: </span><a href="index.php?option=com_contushdvideoshare&view=category&<?php echo $relatedCategoryVal;?>"><?php echo $result[$i]->category;?></a>
  </div>
...
<div class="clear"></div>
 ...
 <?php $t=count($result); if($t>1) { ?><div class="clear"></div>
     <div align="right" class="morevideos"><a href="index.php?option=com_contushdvideoshare&view=relatedvideos"> <?php echo _HDVS_MORE_VIDEOS; ?></a></div><?php }?>
<div class="clear"></div>