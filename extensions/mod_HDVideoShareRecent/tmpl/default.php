...
href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&amp;view=player&amp;" . $recentVideoVal . "&amp;" . $recentCategoryVal); ?>" >
...
?>
	...
	<div class="morevideos">
		<a href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&view=recentvideos"); ?>">
