 ...
 * @abstract      : Contushdvideoshare Recent Videos Module Helper
...
class modrecentvideos {
	...
	public static function getrecentvideossettings() {
		...
		$featurequery = "SELECT siderecentvideorow,siderecentvideocol,seo_option,viewedconrtol,ratingscontrol
