...
href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&amp;view=player&amp;" . $popularVideoVal . "&amp;" . $popularCategoryVal); ?>" >
...
<a href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&amp;view=player&amp;" . $popularVideoVal . "&amp;" . $popularCategoryVal); ?>"
...
if ($t > 1)
{
	...
	<div class="morevideos">
		<a href="<?php
		echo JRoute::_("index.php?option=com_contushdvideoshare&view=popularvideos");
		?>"><?php
