			...
			if ($result[$i]->filepath == "File" || $result[$i]->filepath == "FFmpeg" || $result[$i]->filepath == "Embed")
			{
				if (isset($result[$i]->amazons3) && $result[$i]->amazons3 == 1)
				{
					$src_path = "http://" . $dispenable['amazons3name']
							. ".s3.amazonaws.com/components/com_contushdvideoshare/videos/" . $result[$i]->thumburl;
				}
				else
				{
...
href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&amp;view=player&amp;" . $featuredVideoVal . "&amp;" . $featuredCategoryVal); ?>"
...
echo JRoute::_(
		...
		. $featuredVideoVal . "&amp;" . $featuredCategoryVal
		);
?>"
...
?>
	...
	<div class="morevideos">
		<a href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&view=featuredvideos"); ?>">
