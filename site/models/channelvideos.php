...
class Modelcontushdvideosharechannelvideos extends JModel {
	...
	function getPopularvideos() {
		...
		$query = "SELECT count(a.id)
        				 ...
        				 WHERE a.published=1 AND a.memberid = $memberId AND b.published=1 AND a.type='0'";  
		$db->setQuery($query);
		$total = $db->loadResult();
		$pageno = 1;
	...
	function getTopratedvideos() {
		...
		$start= ($pageno - 1) * $length;
		$topratedquery = "SELECT a.id,a.filepath,a.thumburl,a.title,a.description,a.times_viewed,a.ratecount,a.rate,
					   	  a.videourl,a.times_viewed,a.seotitle,b.category,b.seo_category,d.username,e.catid,e.vid 
