 ...
 * @abstract      : Contushdvideoshare Component Edit Channel Model
	...
	function saveChannel() {
		...
		if (!$row->store()) {
			...
			return false;
                ...
                $channelsettingsquery = "INSERT INTO #__hdflv_channelsettings(channel_id)
                				 VALUES ('$channel_id')";
				$db->setQuery($channelsettingsquery);
				$db->query();
