...
//        $playid_playlistname=JRequest::getVar('id','','get','int');
...
//            $moduleid=JRequest::getVar('id','','get','int');

//            $query="SELECT id,params FROM `#__modules`

//                where id=$moduleid and module='mod_contushdvideoshare'";
...
//
//$fn = new Modelcontushdvideoshareconfigxml ();
//
//$fn->configgetrecords();