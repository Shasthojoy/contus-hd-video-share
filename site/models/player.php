...
class Modelcontushdvideoshareplayer extends ContushdvideoshareModel
{
	...
	public function ratting($videoid)
	{
		...
		if ($id != '')
		{
			// Get Views counting
			$query->clear()
					->select(array('a.times_viewed', 'a.rate', 'a.ratecount', 'a.memberid', 'b.username'))
					->from('#__hdflv_upload AS a')
	 ...
	 * 
	 * @return  gethomepagebottomsettings
	 */
	 ...
	 * 
	 * @return  getHTMLVideoAccessLevel
	 */
