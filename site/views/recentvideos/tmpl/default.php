          ...
          <div class="layout a-b-c">
            ...
            <div class="gr a">
              ...
              <h2 class="home-link hoverable"><?php echo _HDVS_RECENT_VIDEOS; ?></h2>
                         ...
                         <table>
<?
//$totalrecords = count($this->recentvideos);
...
<div class="movie-entry yt-uix-hovercard">
 <a class="tooltip" href="index.php?option=com_contushdvideoshare&view=player&<?php echo $recentCategoryVal; ?>&<?php echo $recentVideoVal; ?>" class="info_hover"><img class="yt-uix-hovercard-target" src="<?php echo $src_path; ?>"  border="0"  width="145" height="80" title=""  />
  ...
  <div class="show-title-container">
    <a href="index.php?option=com_contushdvideoshare&view=player&<?php echo $recentCategoryVal;?>&<?php echo $recentVideoVal;?>" class="show-title-gray info_hover"><?php if(strlen($this->recentvideos[$i]->title)>18) { echo (substr($this->recentvideos[$i]->title,0,18))."..."; } else { echo $this->recentvideos[$i]->title; }?></a>
  </div>
  <span class="video-info">

    <?PHP ECHO _HDVS_CATEGORY; ?>: <a href="index.php?option=com_contushdvideoshare&view=category&<?php echo $recentCategoryVal;?>"><?php echo $this->recentvideos[$i]->category;?></a>
  </span>
...
//                        $dum=0;
                    ...
                    //echo '</table>';
                //$totalr = count($this->recentvideos1);
                    ?>
                        </table>
    </div>
    </div>
