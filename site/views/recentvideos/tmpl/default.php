	...
	if ($user->get('id') != '')
	{
		if (version_compare(JVERSION, '1.6.0', 'ge'))
		{
			...
			<div class="toprightmenu">
				...
				<a href="<?php
echo JRoute::_(
		'index.php?option=com_users&task=user.logout&' . JSession::getFormToken()
		. '=1&return=' . base64_encode(JUri::root())
		);
?>"><?php
				echo JText::_('HDVS_LOGOUT');
				?></a>
			</div>
		<?php
		}
	...
	{
		$current_url = 'index.php?option=com_contushdvideoshare&view=recentvideos';
...
<div class="standard clearfix">
	...
	<div id="video-grid-container" class="clearfix">
		...
		for ($i = 0; $i < $totalrecords; $i++)
		{
			...
			if ($this->recentvideos[$i]->filepath == "File"
				|| $this->recentvideos[$i]->filepath == "FFmpeg"
				|| $this->recentvideos[$i]->filepath == "Embed")
			{
			...
			<li class="video-item">
				<div class="list_video_thumb">
					<a class="featured_vidimg" rel="htmltooltip"
					   href="
<?php
echo 'index.php?option=com_contushdvideoshare&view=player&' . $recentCategoryVal . '&' . $recentVideoVal;
?>
					   ">
				...
				<div class="video_thread">
					<div class="show-title-container">
						...
						. $recentCategoryVal . '&' . $recentVideoVal; ?>" class="show-title-gray info_hover">
	<?php
