 ...
 ?>
            <div id="flashplayer">
                <embed wmode="opaque" src="<?php echo $playerpath; ?>" type="application/x-shockwave-flash"
                       allowscriptaccess="always" allowfullscreen="true" flashvars="baserefJHDV=<?php echo $details1['baseurl']; ?><?php echo $baseref; ?>"  style="width:<?php echo $details1[0]->width; ?>px; height:<?php echo $details1[0]->height; ?>px"></embed>
            </div>
            ...
            <?php
                    } else if(strpos($htmlVideoDetails->videourl,'dailymotion') > 0)
                    {
                        $video      = $htmlVideoDetails->videourl;?>
                    <iframe width="<?php echo $details1[0]->width; ?>" height="<?php echo $details1[0]->height; ?>" src="<?php echo $video; ?>" class="iframe_frameborder" ></iframe>
            <?php
                    }
               if(strpos($htmlVideoDetails->videourl,'viddler') > 0){
            ?>
                    <iframe id="viddler-5b17d44f" src="//www.viddler.com/embed/5b17d44f/?f=1&autoplay=0&player=full&secret=26392356&loop=false&nologo=false&hd=false" width="437" height="288" frameborder="0" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
                        <?php
               }
                } 
            } else {
...
?>
    ...
    <?php } else  if ($dispenable['comment'] == 5) { ?>
...
<div id="commentcontainer" style="margin-top:0px;" class="clearfix clear">
                                <iframe id="myframe1"  width="<?php echo $details1[0]->width; ?>" name="myframe1" class="autoHeight clearfix" frameborder="0" scrolling="no" src="index.php?option=com_contushdvideoshare&view=commentappend&tmpl=component&id=<?php echo $this->videodetails->id; ?>&cmdid=<?php echo $dispenable['comment']; ?>"  >
                                </iframe>
                            </div>
