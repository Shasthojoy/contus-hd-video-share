			...
			if ($thumbview['homefeaturedvideo'] == 1 && $thumbview['homefeaturedvideoorder'] == $coun_tmovie_post)
			{
				...
				<div  id="video-grid-container" class="clearfix">
					<h2 class="home-link hoverable" >
						<a href="index.php?option=com_contushdvideoshare&amp;view=featuredvideos"
						   title="
<?php
...
?>
					...
					<ul class="ulvideo_thumb clearfix">
						...
						for ($i = 0; $i < $totalrecords; $i++)
						{
							...
							if ($this->rs_playlist1[0][$i]->filepath == "File"
								|| $this->rs_playlist1[0][$i]->filepath == "FFmpeg"
								|| $this->rs_playlist1[0][$i]->filepath == "Embed")
							{
								...
								{
									$src_path = "components/com_contushdvideoshare/videos/"
											. $this->rs_playlist1[0][$i]->thumburl;
								}
							}

							if ($this->rs_playlist1[0][$i]->filepath == "Url"
								|| $this->rs_playlist1[0][$i]->filepath == "Youtube")
							{
...
?>"
									...
									{
										if (isset($this->rs_playlist1[0][$i]->ratecount)
											&& $this->rs_playlist1[0][$i]->ratecount != 0)
										{
											$ratestar = round(
													$this->rs_playlist1[0][$i]->rate / $this->rs_playlist1[0][$i]->ratecount
													);
										}
										else
										{
									...
									if ($dispenable['viewedconrtol'] == 1)
										...
										echo $this->rs_playlist1[0][$i]->times_viewed; ?> <?php
										echo JText::_('HDVS_VIEWS'); ?></span>
									<?php
									}
										?>
								</div>
					...
					<a class="playerpage_morevideos"
					   href="index.php?option=com_contushdvideoshare&amp;view=featuredvideos" title="
<?php
...
<?php
echo JHTML::_(
		'string.truncate', (strip_tags($this->rs_playlist1[0][$i]->description)),
		120
		);
?>
							</p>
						...
						if ($dispenable['viewedconrtol'] == 1)
						{
							...
							<div class="tooltip_views_right">
								...
								<span class="view_count">
									<?php echo $this->rs_playlist1[0][$i]->times_viewed; ?> </span>
							</div>
			...
			if ($thumbview['homepopularvideo'] == 1 && $thumbview['homepopularvideoorder'] == $coun_tmovie_post)
			{
				...
				<div id="video-grid-container_pop" class="clearfix">
					<h2 class="home-link hoverable"><a
							href="index.php?option=com_contushdvideoshare&amp;view=popularvideos" title="<?php
					...
					<ul class="ulvideo_thumb clearfix">
						...
						for ($i = 0; $i < $totalrecords; $i++)
						{
							...
							if ($this->rs_playlist1[2][$i]->filepath == "File"
								|| $this->rs_playlist1[2][$i]->filepath == "FFmpeg"
								|| $this->rs_playlist1[2][$i]->filepath == "Embed")
							{
							...
							if ($this->rs_playlist1[2][$i]->filepath == "Url"
								|| $this->rs_playlist1[2][$i]->filepath == "Youtube")
							{
...
?>"
									...
									<div class="clsratingvalue">
										...
										if ($dispenable['ratingscontrol'] == 1)
										{
											if (isset($this->rs_playlist1[2][$i]->ratecount)
												&& $this->rs_playlist1[2][$i]->ratecount != 0)
											{
						...
						?>                                     </ul>
					<a class="playerpage_morevideos"
					   href="index.php?option=com_contushdvideoshare&amp;view=popularvideos" title="
<?php
echo JText::_('HDVS_MORE_VIDEOS');
?>"><?php
echo JText::_('HDVS_MORE_VIDEOS') . ' >';
...
<?php
echo JHTML::_(
		'string.truncate', (strip_tags($this->rs_playlist1[2][$i]->description)),
		120
		);
?>
							</p>
						...
						?>
							<div class="tooltip_views_right">
								<span class="view_txt"><?php echo JText::_('HDVS_VIEWS'); ?>: </span>
								<span class="view_count">
									<?php echo $this->rs_playlist1[2][$i]->times_viewed; ?> </span>
							</div>
		...
		?>
			...
			if ($thumbview['homerecentvideo'] == 1 && $thumbview['homerecentvideoorder'] == $coun_tmovie_post)
			{
				...
				<div id="video-grid-container_rec" class="clearfix">
					<h2 class="home-link hoverable"><a href="<?php
					echo jRoute::_('index.php?option=com_contushdvideoshare&amp;view=recentvideos'); ?>"
					title="<?php echo JText::_('HDVS_RECENT_VIDEOS'); ?>"> <?php
					echo JText::_('HDVS_RECENT_VIDEOS'); ?></a></h2>
					<ul class="ulvideo_thumb clearfix">
						<?php
						...
						for ($i = 0; $i < $totalrecords; $i++)
						{
							...
							if ($this->rs_playlist1[1][$i]->filepath == "File"
								|| $this->rs_playlist1[1][$i]->filepath == "FFmpeg"
								|| $this->rs_playlist1[1][$i]->filepath == "Embed")
							{
							...
							if ($this->rs_playlist1[1][$i]->filepath == "Url"
								|| $this->rs_playlist1[1][$i]->filepath == "Youtube")
							{
...
?>"
									...
									if ($dispenable['ratingscontrol'] == 1)
									{
										if (isset($this->rs_playlist1[1][$i]->ratecount)
											&& $this->rs_playlist1[1][$i]->ratecount != 0)
										{
											$ratestar = round(
													$this->rs_playlist1[1][$i]->rate / $this->rs_playlist1[1][$i]->ratecount
													);
										}
										else
										{
									...
									if ($dispenable['viewedconrtol'] == 1)
										...
										?>
										<span class="floatright viewcolor"><?php
										echo $this->rs_playlist1[1][$i]->times_viewed; ?> <?php
										echo JText::_('HDVS_VIEWS'); ?></span>
									<?php
									}
										?></div>
						...
						?> </ul><a class="playerpage_morevideos" href="<?php
						echo jRoute::_('index.php?option=com_contushdvideoshare&amp;view=recentvideos'); ?>"
						title="<?php echo JText::_('HDVS_MORE_VIDEOS'); ?>"><?php
						echo JText::_('HDVS_MORE_VIDEOS') . ' >'; ?></a>
				</div>
				<!--Tooltip Starts Here-->
				<?php
				for ($i = 0; $i < $totalrecords; $i++)
				{
					...
					<div class="htmltooltip2">
						...
						{
							?>
							<p class="tooltip_discrip"><?php echo JHTML::_(
									'string.truncate', (strip_tags($this->rs_playlist1[1][$i]->description)),
									120
									); ?></p>
				<?php
}
						...
						if ($dispenable['viewedconrtol'] == 1)
						{
							...
							<div class="tooltip_views_right">
								<span class="view_txt"><?php echo JText::_('HDVS_VIEWS'); ?>: </span>
								<span class="view_count"><?php echo $this->rs_playlist1[1][$i]->times_viewed; ?>
								</span>
							</div>
