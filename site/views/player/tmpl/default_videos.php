 ...
 * @abstract      : Contushdvideoshare Component Hdvideoshare Player videos View
...
?>
    ...
    ?>
            ...
            <?php
                if ((($i + 1) % $this->homepagebottomsettings[0]->homefeaturedvideocol) == 0) {
            ?>
    ...
    ?>
            ...
            <?php
                    if ((($i + 1) % $this->homepagebottomsettings[0]->homepopularvideocol) == 0) {
            ?>
                    </ul><ul class="ulvideo_thumb clearfix">
            <?php
                    }
...
<?php } ?>
    ...
    ?>
            ...
            <?php
                    if ((($i + 1) % $this->homepagebottomsettings[0]->homerecentvideocol) == 0) {
            ?>
                    </ul><ul class="ulvideo_thumb clearfix">
            <?php }
