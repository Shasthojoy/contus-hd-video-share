    ...
    <div class="addvideo_top_select">
        <div class="floatleft allform_left">
            ...
            <ul id="upload_thread">
                ...
                <li>
                    <input type="radio" class="butnmargin" name="filetype" id="filetype2" value="0" onclick="filetypeshow(this);" /><span class="select_videotype"> <?php echo JText::_('HDVS_YOUTUBE'); ?> / <?php echo JText::_('HDVS_VIMEO'); ?> / <?php echo JText::_('HDVS_DAILYMOTION'); ?> / <?php echo JText::_('HDVS_VIDDLER'); ?></span>
                </li>
                <?php } if (isset($upload_methods['Upload'])) { ?>
                <li>
                ...
                <?php } if (isset($upload_methods['RTMP'])) { ?>
                <li>
                    <input type="radio"  class="butnmargin" name="filetype" id="filetype4" value="3" onclick="filetypeshow(this);"/> <span class="select_upload">RTMP</span>
                </li>
                <?php } ?>
            </ul>
        </div>
                ...
                <li class="videoupload_list">
                    ...
                    <div class="catclass floatleft" align="left" id="selcat"> <?php $n = count($this->videocategory);
                            foreach ($this->videocategory as $cat) {
                                ?> <a class="cursor_pointer" title="<?php echo $cat->category; ?>" onclick="catselect('<?php echo $cat->category; ?>');"><?php echo $cat->category . ","; ?></a>  <?php } ?></div>
                </li>
                <li class="videoupload_list">
...
<script type="text/javascript">
    ...
    filetypeshow(0);
    <?php } else if (isset($upload_methods['Upload'])) { ?>
    document.getElementById("filetype1").checked = true;
    filetypeshow(1);
    <?php } else if (isset($upload_methods['URL'])) { ?>
    document.getElementById("filetype3").checked = true;
    filetypeshow(2);
    <?php } else if (isset($upload_methods['RTMP'])) { ?>
