...
<!-- <div class="radiobtn" ><input type="radio" name="filetype" id="filetype3" value="2"  onclick="filetypeshow(this);"/>&nbsp;&nbsp;Upload</div> -->
                </li>
            </div>
            <br/>
...
<?php if(JRequest::getVar('type','','get','string') == 'edit') $javascript = ''; else $javascript = 'onsubmit="return videoupload();"';  ?>
...
foreach($this->videocategory as $cat) { ?>
    ...
    <?php } ?>
                    ...
                    <br/><br/><?php if (JRequest::getVar('type','','get','string') == 'edit') { $editbutton = _HDVS_UPDATE; } else {  $editbutton = _HDVS_UPLOAD; } ?>
...
if(urltype.value==1)
    {
      document.getElementById('imageurltype').innerHTML='<input type="text" name="thumburl" value="<?php if(isset($videoedit->thumburl))echo $videoedit->thumburl;?>" class="text" size="20" id="thumburl"/>';
        ...
        {
      document.getElementById('imageurltype').innerHTML='<input type="file" name="thumburl" value="<?php if(isset($videoedit->thumburl))echo $videoedit->thumburl;?>" class="text" size="20" id="thumburl"/>';
        }
}
