			...
			<li class="video-item">
				<div class="list_video_thumb">
					<a class="featured_vidimg" rel="htmltooltip"
					   href="
<?php
echo 'index.php?option=com_contushdvideoshare&view=player&' . $relatedCategoryVal . '&' . $relatedVideoVal;
?>
					   ">
				...
				<div class="show-title-container">
					<a href="<?php echo 'index.php?option=com_contushdvideoshare&view=player&' . $relatedCategoryVal
							. '&' . $relatedVideoVal; ?>" class="show-title-gray info_hover">
	<?php
