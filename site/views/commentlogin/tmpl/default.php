...
<fieldset class="input">
	...
	<input name="return" value="<?php if(JRequest::getvar('mode','','get','string'))
{ echo  base64_encode('index.php?option=com_contushdvideoshare&view=player'); }else{ echo  base64_encode('index.php?option=com_contushdvideoshare&view=commentlogin&mode=close'); } ?>" type="hidden">
