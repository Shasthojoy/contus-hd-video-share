...
echo JRoute::_(
		...
		?>
			<div class="toprightmenu">
				<a href="index.php?option=com_contushdvideoshare&view=myvideos">
					<?php echo JText::_('HDVS_MY_VIDEOS'); ?></a> |
	...
	{
		$current_url = 'index.php?option=com_contushdvideoshare&view=featuredvideos';
...
<div class="standard clearfix">
	...
	<div id="video-grid-container" class="clearfix">
		...
		for ($i = 0; $i < $totalrecords; $i++)
		{
			...
			if ($this->featuredvideos[$i]->filepath == "File"
				|| $this->featuredvideos[$i]->filepath == "FFmpeg"
				|| $this->featuredvideos[$i]->filepath == "Embed")
			{
				if (isset($this->featuredvideos[$i]->amazons3) && $this->featuredvideos[$i]->amazons3 == 1)
				{
					$src_path = $dispenable['amazons3link']
							. $this->featuredvideos[$i]->thumburl;
				}
				else
				{
			...
			<li class="video-item">
				<div class="list_video_thumb">
					<a class="featured_vidimg" rel="htmltooltip"
					   href="
<?php
echo 'index.php?option=com_contushdvideoshare&view=player&'
. $featuredCategoryVal . '&' . $featuredVideoVal;
?>"
					   >
				...
				<div class="video_thread">
					<div class="show-title-container">
						<a href="<?php echo 'index.php?option=com_contushdvideoshare&view=player&'
						. $featuredCategoryVal . '&' . $featuredVideoVal; ?>" class="show-title-gray info_hover">
	<?php
