			...
			<li class="video-item">
				<div class="list_video_thumb" >
					<a class="featured_vidimg" rel="htmltooltip"
					   href="
<?php
echo 'index.php?option=com_contushdvideoshare&view=player&' . $popularCategoryVal . '&' . $popularVideoVal;
?>
					   ">
				...
				<div class="video_thread">     
					<div class="show-title-container">
						...
						. $popularCategoryVal . '&' . $popularVideoVal; ?>" class="show-title-gray info_hover">
			<?php
