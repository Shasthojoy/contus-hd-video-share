...
if ($cmdid == 4)
{
	...
	if (file_exists($comments))
	{
		...
		echo JComments::showComments(
				JRequest::getVar('id', '', 'get', 'int'),
		...
		<div class="comment_textcolumn">
			...
			<div class="commentstop clearfix" >
				...
				else
				{
					...
					{
						?>
						<div class="commentpost floatright"><a  href="index.php?option=com_users&view=login"
																class="utility-link"><?php
																echo JText::_('HDVS_POST_COMMENT');
																?></a></div>
					<?php
					}
					else
					{
					?>
						<div class="commentpost floatright"><a  href="index.php?option=com_user&view=login"
																class="utility-link"><?php
																echo JText::_('HDVS_POST_COMMENT');
																?></a></div>
				<?php
				...
				?>
						<div class="clearfix" >
							<div class="subhead changecomment" >
								...
								<span  class="video_user_info">
									<span class="user_says"> Posted on: <?php
								...
								<div class="reply changecomment1"><a class="cursor_pointer"
