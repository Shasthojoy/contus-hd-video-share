...
<div id="add_playlist" style="display: none;">
			...
			<?php echo JText::_('HDVS_CREATE_PLAYLIST');?>
            </h1>
            <div class="clear"></div>

            <div>
            <form action="<?php echo JRoute::_( 'index.php?option=com_contushdvideoshare&view=playlist' ); ?>" method="post">
                <div  style="float: left;padding: 5px 0 15px 0;"><label><b><?php echo JText::_('HDVS_PLAYLIST_NAME');?></b></label>
            <input type="text" id="category" name="category" ></div>

            <div class="clear"></div>
            <h1 Style="width:auto;text-decoration: underline;border:none;font-size: 15px;"><?php echo JText::_('HDVS_PLAYLIST_COMMENT');?></h1>
            ...
            <input type="checkbox" name="playlist_videos[]" value="<?php echo $myVideos[$i]->id;?>"/>
					...
					?>									<div class="movie-entry yt-uix-hovercard">
                                                                              <div class="tooltip">
                                          <p class="thumb_resize"><img class="yt-uix-hovercard-target" src="<?php echo $src_path; ?>"  border="0"  width="145" height="80" title="" alt="thumb_image" /></p>
                                              </div>
                                                                    </div>
                                                                    </div>
            ...
            <div class="clear"></div>
                ...
                <button style="margin-right:10px;" class="button floatright" type="submit" onclick="return playlistvalidation();"><?php echo JText::_('HDVS_SAVE');?></button>
...
<?php }else {?>
<div id="playlist">
<h1><?php echo JText::_('HDVS_MY_PLAYLISTS');?></h1> <button id="addnewbutton" type="button" class="button floatright" onclick="addplaylist()"><?php echo JText::_('HDVS_ADD_NEW');?></button>
<?php		if(isset($this->channelvideos)) {
                                        ...
                                        ?>
                                        <div  style="float: left;padding:5px;">
                                        <a href = "<?php echo JRoute::_('index.php?option=com_contushdvideoshare&view=playlist&category='.trim($category),true); ?>"><?php echo $this->channelvideos[$i][0]->category; ?></a>
														<div class="movie-entry yt-uix-hovercard">
                                                                              <div class="tooltip">
...
$channel_id = JRequest::getVar('channelid');
 ...
 if($last > 1) {
 for($i=1;$i<=$last;$i++) { ?>
 	<a class="<?php if($curr_page == $i) { echo 'activepage'; }?>" style="color: white;" href="<?php echo JRoute::_('index.php?option=com_contushdvideoshare&view=playlist&page='.$i,true); ?>" ><?php echo $i;?></a>
<?php  } }
if($curr_page < $last) {
 ?>
...
<?php } else {?>
<b><?php echo JText::_('HDVS_NO_PLAYLIST');?></b>
<?php }?>
</div>
<?php }?>
</div>